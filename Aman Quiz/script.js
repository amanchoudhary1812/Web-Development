...
function checkName() {
  ...
  if (document.querySelector("#container .name").value == "") {
    name_input.value = "";
    name_input.placeholder = "kamu nggak punya nama?";
  } else {
    name_input.placeholder = "Siapa nama kamu?";
    name_box.classList.remove("activeName");
    info_box.classList.add("activeInfo");
    username = name_input.value;
    console.log("Nama kamu " + username);
  }
}
...
function showResultBox() {
  ...
  let scoreTag = "<span>kamu mendapatkan<p>" + userScore + "</p> Poin</span>";
...
function changeText() {
  ...
  changetext.innerHTML =
    "Selamat " + username + "! kamu berhasil menyelesaikan quiz";
}
